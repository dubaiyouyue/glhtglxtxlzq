...
public function assign($k,$v=''){
	$this->vars=isset($this->vars)?$this->vars:array();
	if(is_array($k)){
...
public function Show($Render=false,$args=array()) {
	$Ok = true;
	...
	$cache_file=$cache_path.md5($_SERVER['SCRIPT_NAME'].$_SERVER['REQUEST_URI']).'.php';
	//编译模板
	$html=tpl_replace($this->Source);
